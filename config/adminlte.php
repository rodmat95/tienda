...
return [
    ...
    */
    ...
    'classes_body' => 'bg-gradient-secondary',
    'classes_brand' => 'navbar-dark bg-gradient-dark',
    'classes_brand_text' => 'text-white',
    'classes_content_wrapper' => 'bg-light',
    'classes_content_header' => 'bg-light',
    'classes_content' => 'my-3',
    'classes_sidebar' => 'sidebar-dark-info elevation-4',
    'classes_sidebar_nav' => 'nav-child-indent',
    'classes_topnav' => 'navbar-dark navbar-light bg-gradient-dark',
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Lista de Distribuciones',
            'route'  => 'admin.distributions.index',
            'icon' => 'fas fa-fw fa-clipboard',
            'can' => 'admin.distributions.index'
        ],
        [
            'text' => 'Crear Distribución',
            'route'  => 'admin.distributions.create',
            'icon' => 'fas fa-fw fa-file',
            'active' => request()->is('admin/distributions/create', 'admin/distributions/*/edit'),
            'can' => 'admin.distributions.create'
        ],
    ],
